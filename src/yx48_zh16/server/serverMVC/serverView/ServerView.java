...
/**
 * The view of the server holding the game.
 *
 * @param <TEndPoint> The type of the object in the discovery server
 */
public class ServerView<TEndPoint> extends JFrame {
	
	/**
	 * The generated serial version UID.
	 */
	private static final long serialVersionUID = 7008268644597623793L;
	...
	/**
	 * The label indicating it being a server.
	 */
	private final JLabel ServerLabel = new JLabel("Server App");
	
	/**
	 * The Panel for displaying the map.
	 */
	private final JPanel MapPanel = new JPanel();
	
	/**
	 * The button for sending a map to clients.
	 */
	private final JButton btnMapButton = new JButton("Send Map");
	
	/**
	 * The text field for the map name.
	 */
	private final JTextField textMapNameField = new JTextField();
	/**
	 * button to send game
	 */
	 ...
	 */
	public ServerView(IView2ModelAdapter iView2ModelAdapter, IDiscoveryPanelAdapter<TEndPoint> discoveryServerPanelAdapter) {
		textMapNameField.setToolTipText("insert game name here");
		textMapNameField.setColumns(10);
	...
	private void initGUI() {
		...
		ServerLabel.setToolTipText("The server application.");
		loginPane.add(ServerLabel);
...
//		});
		...
		btnSendGame.setToolTipText("Click here to send the game and divde all users into two teams.");
		btnSendGame.addActionListener(new ActionListener() {

			@Override
			public void actionPerformed(ActionEvent e) {
				// TODO Auto-generated method stub
				iView2ModelAdapter.sendGame();
			}
			
		});
		gamePnl.setToolTipText("Game functionality associated panel.");
		
		gamePnl.add(btnSendGame);
		btnStartGame.setToolTipText("Click here to start the game on each player's side.");
		...
		btnStartGame.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				// TODO Auto-generated method stub
				iView2ModelAdapter.startGame();
			}
			
		});
		gamePnl.add(btnStartGame);
		controlPanel.add(gamePnl);
		gamePnl.setLayout(new GridLayout(2, 0, 0, 0));
		btnEndGame.setToolTipText("Click here to end the game in current teams and calculate scores. ");
		...
		btnInvite.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				System.out.println( ((Room) connectedChatRooms.getItemAt(connectedChatRooms.getSelectedIndex()).getChatRoom()).getInfo().getName());
			}
		});
		...
		MapPanel.add(textMapNameField);
		
		MapPanel.add(btnMapButton);
		tabbedPane.setToolTipText("Your rooms are displayed in this panel.");
		
		
//		btnMapButton.addActionListener(new ActionListener() {
//			public void actionPerformed(ActionEvent e) {
//				iView2ModelAdapter.sendMap(textMapNameField.getSelectedText());
//			}
//		});
	 ...
	 */
	public void installRoom(String roomName, ServerMiniView miniView) {
		// TODO Auto-generated method stub
	 ...
	 */
	public void removeRoom(ServerMiniView miniView) {
